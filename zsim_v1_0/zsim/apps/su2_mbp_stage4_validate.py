"""CLI for stage-4 chiral/caloron MBP validation in Z-Sim v1.0."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Run stage-4 chiral/caloron MBP validation for Z-Sim v1.0.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v1.0 stage-4 MBP validation failed.', exc)
    return print_cli_summary('Z-Sim v1.0 stage-4 MBP validation complete.', summary, ordered_keys=('success', 'shape', 'background', 'projector_mode', 'chirality_mode', 'num_rows', 'output_dir'))
