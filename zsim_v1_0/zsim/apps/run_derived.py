"""Z-Sim v1.0 — Run with DERIVED closures (zero free parameters).
...
def run_derived(config_path: str | Path = "configs/derived.yaml",
    ...
    print("=" * 70)
    print("  Z-Sim v1.0 — DERIVED Closures (Zero Free Parameters)")
    print("=" * 70)
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Z-Sim v1.0: run with theory-derived closures (zero free parameters).")
