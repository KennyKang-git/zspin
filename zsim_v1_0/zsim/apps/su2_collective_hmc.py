"""CLI for reduced collective-coordinate HMC in Z-Sim v1.0."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Run reduced collective-coordinate HMC for Z-Sim v1.0.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v1.0 collective HMC failed.', exc)
    return print_cli_summary('Z-Sim v1.0 collective HMC complete.', summary, ordered_keys=('success', 'shape', 'plaquettes', 'accept_rate', 'output_dir'))
