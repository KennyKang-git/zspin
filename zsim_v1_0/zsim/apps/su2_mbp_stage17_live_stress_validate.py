...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run the stage-17 live stress validation harness for Z-Sim v1.0.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v1.0 stage-17 live stress validation failed.', exc)
    return print_cli_summary(
        'Z-Sim v1.0 stage-17 live stress validation complete.',
        summary,
        ordered_keys=(
            'success',
