...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run stage-6 pairing-aware MBP validation for Z-Sim v1.0.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v1.0 stage-6 pairing validation failed.', exc)
    return print_cli_summary('Z-Sim v1.0 stage-6 pairing validation complete.', summary, ordered_keys=('success', 'shape', 'scan_schemes', 'compare_schemes', 'num_scan_rows', 'num_scheme_rows', 'output_dir'))
