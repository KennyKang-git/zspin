"""CLI for exact polyhedral spectral calculations in Z-Sim v1.0."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Run exact Z-Sim v1.0 quantum topology calculations.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v1.0 quantum topology run failed.', exc)
    return print_cli_summary('Z-Sim v1.0 quantum topology run complete.', summary, ordered_keys=('success', 'geometry', 'counts', 'output_dir'))
