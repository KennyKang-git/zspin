...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run stage-11 stress-ledger validation for Z-Sim v1.0.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v1.0 stage-11 stress-ledger validation failed.', exc)
    return print_cli_summary('Z-Sim v1.0 stage-11 stress-ledger validation complete.', summary, ordered_keys=('success', 'shape_grid', 'selected_shape', 'selected_sign_method', 'selected_scheme', 'num_shape_rows', 'num_stress_rows', 'output_dir'))
