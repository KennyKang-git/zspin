#!/usr/bin/env python3
"""Z-Sim v1.0 — Setup & Verification Script.
...
def main():
    print("=" * 60)
    print("  Z-Sim v1.0 — Setup & Verification")
    print("=" * 60)
    ...
    if not os.path.exists("zsim/core/constants.py"):
        print("\n  [ERROR] Run this script from inside the zsim_v1_0 folder!")
        print("  Example:")
        print("    cd zsim_v1_0")
    ...
    if test_result.returncode == 0:
        print("  [SUCCESS] Z-Sim v1.0 is ready!")
        print("=" * 60)
        print()
