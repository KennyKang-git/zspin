#!/usr/bin/env python3
"""Z-Sim v3.1 — Tier-0.7 CAMB Comparison Script.
...
# Z-Spin constants
A = 35 / 437
OMEGA_M_EFF = 38.0 / (121.0 * (1.0 + A))  # v6.1: face counting; was 39/121
...
def make_plot(ells, tt_planck, tt_zspin, output_path="zspin_cmb_comparison.png"):
    ...
    ax1.set_xlim(2, 2000)
    ax1.set_title('Z-Sim v3.1 — CMB TT Power Spectrum', fontsize=14)
...
def main():
    ...
    print("=" * 70)
    print("  Z-Sim v3.1 — CAMB CMB Power Spectrum Comparison")
    print("=" * 70)
