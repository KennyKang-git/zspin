...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run stage-10 direct comparison validation for Z-Sim v4.1.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v4.1 stage-10 direct comparison validation failed.', exc)
    return print_cli_summary('Z-Sim v4.1 stage-10 direct comparison validation complete.', summary, ordered_keys=('success', 'shape_grid', 'selected_shape', 'selected_sign_method', 'selected_scheme', 'num_shape_rows', 'num_comparison_rows', 'output_dir'))
