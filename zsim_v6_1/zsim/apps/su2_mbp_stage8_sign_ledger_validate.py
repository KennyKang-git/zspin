...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run stage-8 sign-ledger validation for Z-Sim v3.9.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v3.9 stage-8 sign-ledger validation failed.', exc)
    return print_cli_summary('Z-Sim v3.9 stage-8 sign-ledger validation complete.', summary, ordered_keys=('success', 'shape', 'scan_schemes', 'compare_schemes', 'sign_methods', 'selected_sign_method', 'selected_scheme', 'num_sign_rows', 'num_ledger_rows', 'output_dir'))
