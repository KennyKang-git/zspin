...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run stage-7 overlap-aware MBP validation for Z-Sim v3.8.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v3.8 stage-7 overlap validation failed.', exc)
    return print_cli_summary('Z-Sim v3.8 stage-7 overlap validation complete.', summary, ordered_keys=('success', 'shape', 'scan_schemes', 'compare_schemes', 'num_scan_rows', 'num_scheme_rows', 'output_dir'))
