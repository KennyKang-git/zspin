...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run stage-5 Wilson/staggered spinor MBP validation for Z-Sim v3.6.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v3.6 stage-5 spinor/valley validation failed.', exc)
    return print_cli_summary('Z-Sim v3.6 stage-5 spinor/valley validation complete.', summary, ordered_keys=('success', 'shape', 'projector_mode', 'chirality_mode', 'fermion_scheme', 'num_fit_rows', 'output_dir'))
