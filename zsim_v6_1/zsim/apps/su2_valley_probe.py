"""CLI for reduced collective-coordinate valley probes in Z-Sim v3.4."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Probe reduced collective-coordinate valleys in Z-Sim v3.4.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v3.4 SU(2) valley probe failed.', exc)
    return print_cli_summary('Z-Sim v3.4 SU(2) valley probe complete.', summary, ordered_keys=('success', 'shape', 'plaquettes', 'output_dir'))
