"""CLI for reduced MBP bilinear extraction in Z-Sim v3.4.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Extract reduced MBP bilinear coefficients for Z-Sim v3.4.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v3.4 MBP extraction failed.', exc)
    return print_cli_summary('Z-Sim v3.4 MBP extraction complete.', summary, ordered_keys=('success', 'shape', 'background', 'projector_mode', 'chirality_mode', 'fermion_scheme', 'wilson_r', 'num_rows', 'output_dir'))
