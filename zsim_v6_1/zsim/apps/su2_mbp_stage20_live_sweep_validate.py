...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run the stage-20 live sweep expansion validation harness for Z-Sim v5.1.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v5.1 stage-20 live sweep expansion validation failed.', exc)
    return print_cli_summary(
        'Z-Sim v5.1 stage-20 live sweep expansion validation complete.',
        summary,
        ordered_keys=(
            'success',
