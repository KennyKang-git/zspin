"""CLI for reduced SU(2) BCC scans in Z-Sim v3.4."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Run reduced SU(2) BCC scans for Z-Sim v3.4.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v3.4 SU(2) BCC scan failed.', exc)
    return print_cli_summary('Z-Sim v3.4 SU(2) BCC scan complete.', summary, ordered_keys=('success', 'shape', 'plaquettes', 'output_dir'))
