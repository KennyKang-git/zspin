...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run the stage-15 recompute-aware validation harness for Z-Sim v4.6.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v4.6 stage-15 recompute-aware validation failed.', exc)
    return print_cli_summary(
        'Z-Sim v4.6 stage-15 recompute-aware validation complete.',
        summary,
        ordered_keys=(
            'success',
