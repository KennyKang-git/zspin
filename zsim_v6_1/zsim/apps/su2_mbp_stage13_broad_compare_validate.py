...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run stage-13 broad-vs-lightweight comparison validation for Z-Sim v4.4.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v4.4 stage-13 broad-vs-lightweight comparison validation failed.', exc)
    return print_cli_summary('Z-Sim v4.4 stage-13 broad-vs-lightweight comparison validation complete.', summary, ordered_keys=('success', 'broad_shape_grid', 'lightweight_shape_grid', 'selected_shape', 'selected_sign_method', 'selected_scheme', 'selected_source_label', 'num_preset_rows', 'num_comparison_rows', 'output_dir'))
