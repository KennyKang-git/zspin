...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description='Run stage-12 closure-calibration validation for Z-Sim v4.3.')
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return print_cli_failure('Z-Sim v4.3 stage-12 closure-calibration validation failed.', exc)
    return print_cli_summary('Z-Sim v4.3 stage-12 closure-calibration validation complete.', summary, ordered_keys=('success', 'shape_grid', 'selected_shape', 'selected_sign_method', 'selected_scheme', 'num_coverage_rows', 'num_calibration_rows', 'output_dir'))
